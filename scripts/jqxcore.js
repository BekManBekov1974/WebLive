...
(function (a) {
  ...
  a.jqx.hasFunction = function (e, d) {
    ...
    var f = typeof d == Array || d.length > 0 ? d[0] : d;
    var c =
      typeof d == Array || d.length > 1 ? Array.prototype.slice.call(d, 1) : {};
    while (e[f] == undefined && e.base != null) {
  ...
  a.jqx.jqxWidgetProxy = function (g, c, b) {
    ...
    throw (
      "jqxCore: Invalid parameter '" + a.jqx.serialize(b) + "' does not exist."
    );
    return undefined;
  };
        ...
        return jQuery.access(
          ...
          function (s) {
            ...
            if (
              typeof s === "string" &&
              !r.test(s) &&
              (jQuery.support.htmlSerialize || !k.test(s)) &&
              (jQuery.support.leadingWhitespace || !q.test(s)) &&
    ...
    if (e == undefined) {
      a.each(c.aria, function (g, h) {
        ...
        if (k != undefined && !a.isFunction(k)) {
          ...
          try {
            !c.base
              ? c.host.attr(g, k.toString())
              : c.base.host.attr(g, k.toString());
          } catch (f) {}
        }
      });
    } else {
  ...
  a.extend(a.jqx.mobile, {
    ...
    touchScroll: function (d, y, g, D, b, k) {
      ...
      if (this.simulatetouches) {
        ...
        a(window).on != undefined
          ? a(document).on("mouseup.touchScroll", z)
          : a(document).bind("mouseup.touchScroll", z);
        if (window.frameElement) {
          if (window.top != null) {
            ...
            if (window.top.document) {
              a(window.top.document).on
                ? a(window.top.document).on("mouseup", r)
                : a(window.top.document).bind("mouseup", r);
            }
          }
        }
        ...
        a(document).on != undefined
          ? a(document).on("touchend", w)
          : a(document).bind("touchend", w);
      }
      var f = function (E) {
        if (!B.enableScrolling[D]) {
          return true;
      ...
      q.on
        ? q.on(p + " touchcancel.touchScroll", f)
        : q.bind(p + " touchcancel.touchScroll", f);
    },
  });
